      ...
      {isAdvanceAskAI && (
        ...
        >
          <div
            ...
            title={isChatStarted ? "Mode is locked for this chat" : "Click to turn off Advance Ask AI mode"}
          >
            <IconSparkles size={14} style={{ color: isChatStarted ? "#a0a0a0" : "var(--tile-label-color, #F7EF8A)" }} />
            <span>Advance Ask AI</span>
            <span
              style={{
                width: "6px",
