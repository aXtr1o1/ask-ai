...
export default function ComplaintsModal({ onClose }: ComplaintsModalProps) {
  return (
    <div
      style={{
        position: "fixed",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", marginTop: "8px", gap: "12px" }}>
          ...
          <div>
            <h3 style={{ margin: "0 0 4px 0", fontSize: "20px", fontWeight: 700, letterSpacing: "-0.02em" }}>
              Facility Complaints via AI
            </h3>
            <p style={{ margin: 0, fontSize: "14px", color: "var(--color-text-muted)" }}>
              Ask the assistant to log and track complaints.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px", margin: "24px 0" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              "Report broken light in Room 302",
              "AC is not cooling in boardroom alpha",
              "Request cleaning for 4th floor pantry",
