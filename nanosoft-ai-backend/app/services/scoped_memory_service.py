...
def build_scoped_messages(
    ...
    memory_instructions = (
        ...
        "  'those records', 'from the above results', 'what about', 'how about',\n"
        "  'in that', 'for that', 'from that', 'what if'\n"
        ...
        "  → CRITICAL: NEVER pass a 'limit' parameter unless the user explicitly specifies a number (e.g., 'top 5'). If they just say 'list them', do NOT set a limit.\n"
        ...
        "  → Example: previous='29 [Entity X]', current='so list me them'\n"
        "    → call [TOOL FOR ENTITY X](...)\n\n"
