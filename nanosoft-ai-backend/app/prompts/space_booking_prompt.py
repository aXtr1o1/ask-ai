...
SPACE_BOOKING_SYSTEM_PROMPT = SystemMessage(content=(
    ...
    "  — Searches the facility's space inventory by building name, spot name, spot code, or floor.\n"
