...
logger = logging.getLogger("understanding_agent")
...
def _build_model() -> ChatGoogleGenerativeAI:
    ...
    return ChatGoogleGenerativeAI(
        ...
        model_kwargs={"thinking": {"thinking_budget": 3000}},
    )


# -- Console log printer -------------------------------------------------------

def _print_understanding_log(intent: dict, thinking_tokens: int, query: str) -> str:
