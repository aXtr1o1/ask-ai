...
Tool implementations live in:
  ...
  tools_basic.py     — Tools 1–9   (count, sum, avg, group, math, records, sort)
  tools_advanced.py  — Tools 10–19 (age, MTBF, time-period, threshold, rate,
                                     percentile, forecast, date-compare,
                                     merge-score, duration-add)
"""

# ── Helpers (used by queue_runner and context_builder) ────────────────────────
from app.api.advance.execution._helpers import (           # noqa: F401
...
# ── Basic Tools (1–9) ─────────────────────────────────────────────────────────
from app.api.advance.execution.tools_basic import (        # noqa: F401
    count_records,
    sum_values,
    get_average,
    group_by_and_count,
...
# =============================================================================
# ALL_TOOLS — used by the planner for tool descriptions
# =============================================================================
ALL_TOOLS = [
    # Basic Tools
    count_records,
