...
class FAInput(BaseModel):
    ...
    floor: Optional[str] = Field(None, description="Specific floor level within the building where the FA complaint is located. Map if user mentions 'Floor' or 'Floor Name'. Example values: Floor 1, Ground Floor.")
    ...
    keyword: Optional[str] = Field(None, description="Fallback search term ONLY when the user's value clearly does not match any known field. Do not use for values that belong to division, building, floor, stage, category, contract, or any other defined field.")
...
class SBInput(BaseModel):
    ...
    floor: Optional[str] = Field(None, description="Specific floor level within the building for this SB work order. Map if user mentions 'Floor'. Example values: Floor 1, Ground Floor.")
    ...
    keyword: Optional[str] = Field(None, description="Fallback search term ONLY when the user's value clearly does not match any known field. Do not use for values that belong to division, building, floor, stage, service_type, contract, or any other defined field.")
