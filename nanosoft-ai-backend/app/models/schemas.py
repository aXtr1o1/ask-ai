...
class AssetsInput(BaseModel):
    ...
    asset_tag_no: Optional[str] = Field(None, description="Unique tag number that identifies the asset in the system. Use for tag-based searches. Example values: L1-HVAC-CHL-3827, AJ-DV-DV-3826, T-A1-DV-DV-3825, DM-FF&AS-FE-13802.")
    asset_barcode: Optional[str] = Field(None, description="Barcode number printed on the asset label used for scanning and physical identification. Map if user mentions 'Barcode' or 'Asset Barcode'. Example values: 1731251675376, 1731251675374.")
